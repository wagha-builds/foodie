...
import { useAuth, useTheme } from "../../lib/store"; // Added useTheme
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4 py-4">
                    ...
                    <Button 
                      ...
                      disabled={!newAddress.fullAddress}
                    >
            ...
            <CardContent className="space-y-4">
              {addresses.length === 0 ? (
                ...
                addresses.map((address) => (
                  <div key={address.id} className="flex items-start justify-between p-4 border rounded-lg bg-card hover:bg-accent/5 transition-colors">
                    <div className="flex gap-3">
                      <div className="mt-1 h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                        <MapPin className="h-4 w-4 text-primary" />
                      </div>
                      <div>
                        <p className="font-semibold capitalize">{address.label}</p>
